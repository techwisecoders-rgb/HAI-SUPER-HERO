...
export default function TrendingPage() {
  ...
  const showView = (viewId: string) => {
    ...
    if (viewId === "electricianView") {
      const chatArea = document.getElementById("chatAreaElectrician");
      if (chatArea) {
        chatArea.innerHTML = "";
        runSequentialDemo(electricianSteps, chatArea);
      }
    } else if (viewId === "plumberView") {
      const chatArea = document.getElementById("chatAreaPlumber");
      if (chatArea) {
        chatArea.innerHTML = "";
        runSequentialDemo(plumberSteps, chatArea);
      }
    }
  };
  ...
  const runSequentialDemo = (
    steps: Array<{ type: string; text?: string; html?: string }>,
        ...
        <div className="chat-view-wrapper">
          <div className="chat-container">
            ...
            <footer className="chat-footer">
              ...
              <button type="button" className="send-btn" disabled>Send</button>
              🔄
            </footer>
          </div>
        </div>
        ...
        .scrollBody {
          ...
          background:
            repeating-linear-gradient(transparent,
              transparent 28px,
              rgba(0, 75, 115, 0.35) 28px,
              rgba(0, 75, 115, 0.35) 30px),
