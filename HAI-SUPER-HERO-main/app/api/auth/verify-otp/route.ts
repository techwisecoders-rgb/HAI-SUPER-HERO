...
export async function POST(req: NextRequest) {
  ...
  // Always set the auth cookies — these are required for /api/business and
  // other protected routes. The session cookie is only set when a chat
  // session exists, but the user identity cookies must always be present.
  res.headers.append(
    "Set-Cookie",
